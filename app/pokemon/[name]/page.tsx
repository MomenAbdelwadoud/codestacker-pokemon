...
import {ArrowLeftSquare, ListOrdered, Ruler, Weight} from "lucide-react";
...
export default async function PokemonDetailsPage({
	...
	return (
		<div className="flex justify-center items-center h-full">
			<Card className="w-fit h-fit z-10 bg-none border-2 border-dark shadow-mainCard flex flex-col rounded-sm md:py-5 gap-6">
				<CardHeader className="xl:h-1/3 flex justify-between px-5 xl:px-10 gap-5 xl:gap-10 items-start flex-col xl:flex-row">
					...
					<Link href={"/"}>
						<div className="shadow-badge border-1 border-secondary p-1 absolute top-5 right-5">
							<ArrowLeftSquare className="text-secondary"></ArrowLeftSquare>
						</div>
					</Link>
				</CardHeader>
